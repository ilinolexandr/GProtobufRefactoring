...
namespace GProtobuf.Benchmark.Messages
{
    ...
    public class EmptyMessageBenchmark : SerdeBenchmarkBase<MinimalMessageModel>
    {
        ...
        protected override byte[] PreSerialize(MinimalMessageModel model)
        {
            ...
            Models.Messages.Serialization.Serializers.SerializeMinimalMessageModel(ms, model);
            return ms.ToArray();
        }
        ...
        {
            Models.Messages.Serialization.Serializers.SerializeMinimalMessageModel(Stream, Model);
            return Stream.Length;
        }
