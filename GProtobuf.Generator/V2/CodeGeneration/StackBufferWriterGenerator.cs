...
namespace GProtobuf.Generator.V2.CodeGeneration
{
    ...
    internal class StackBufferWriterGenerator : StreamWriterGenerator
    {
        ...
        public StackBufferWriterGenerator(StringBuilderWithIndent sb, TypeRegistry registry, VirtualMapTypeRegistry virtualMapRegistry, VirtualTupleTypeRegistry virtualTupleRegistry, string virtualTypesNamespace, ProxyRegistry proxyRegistry)
            : base(sb, registry, virtualMapRegistry, virtualTupleRegistry, "StackBuffer", virtualTypesNamespace, proxyRegistry)
        {
        }
    }
}
